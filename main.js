...
let bgstyle = bg.style.cssText

console.log(bg)
console.log(document.getElementById('bg').style.cssText)
console.log(height)
//bgstyle = 'height:' + parseInt(height) + 'px;'
document.getElementById('bg').style.cssText = 'height:' + parseInt(height) + 'px;'
...
if ((height/iconheight) > (width/iconwidth)) {
    //image.style.cssText = 'height: 100%;width: auto;'
...
window.onload = function() {
    ...
    file.onchange = function() {
      ...
      function renderFrame() {
        ...
        ctx.fillStyle = "rgba(0,0,0,0)"; // Clears canvas before rendering bars (black with opacity 0.2)
        //document.getElementById('img').src = 'logo512.png'
